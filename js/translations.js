window.TRANSLATIONS = {
  en: {
    ...
    tipTaxStructure:    "Individual (PF): 10% flat CGT on profit (Fiscal Code Art. 111). Company/SRL: 16% corporate tax but operational deductions are possible.",
    ...
    tipCapitalGainsTax: "Romanian CGT: 10% for individuals or 16% for SRL, applied to net profit only.",
  ...
  ro: {
    ...
    tipTaxStructure:    "Persoană fizică (PF): 10% impozit flat pe profit (Codul Fiscal Art. 111). Firmă/SRL: 16% impozit pe profit, dar pot fi deduse cheltuielile operaționale.",
    ...
    tipCapitalGainsTax: "Impozit pe câștig de capital în România: 10% pentru PF sau 16% pentru SRL, aplicat doar la profit pozitiv.",
  ...
  he: {
    ...
    tipTaxStructure:    "יחיד (PF): 10% מס רווח הון שטוח על הרווח (סעיף 111 לחוק המס). חברה/SRL: 16% מס חברות עם אפשרות לניכוי הוצאות.",
    ...
    tipCapitalGainsTax: "מס רווח הון ברומניה: 10% ליחיד או 16% ל-SRL, מחושב רק על רווח חיובי.",
